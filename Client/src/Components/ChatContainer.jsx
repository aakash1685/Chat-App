  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      ...
      <div className="flex items-center gap-3 py-3 mx-4 border-b border-stone-500">
        ...
        ></img>
        <img src={assets.help_icon} className="max-md:hidden max-w-5 cursor-pointer" />
      </div>
      {/* Chat Area */}
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3">
        ...
        <img src={assets.send_button} className="w-9 cursor-pointer"/>
      </div>
    </div>
  ) : (
    <div className="flex flex-col items-center justify-center gap-2 text-white bg-white/10 max-md:hidden">
